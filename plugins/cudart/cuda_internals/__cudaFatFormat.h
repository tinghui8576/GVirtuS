...
void __cudaFatGetCandidateForGpuWithPolicy( __cudaFatCudaBinary *binary, __cudaFatCompilationPolicy policy, char* gpuName, char* *candidate, unsigned char *is_ptx, char* *dbgInfoFile );
