...
extern "C" __host__ cudaError_t CUDARTAPI cudaThreadExchangeStreamCaptureMode(cudaStreamCaptureMode* mode) {
...
extern "C" __host__ cudaError_t CUDARTAPI cudaStreamBeginCapture(
    cudaStream_t stream,
...
// TODO: needs testing
extern "C" __host__ cudaError_t CUDARTAPI cudaStreamEndCapture(cudaStream_t stream, cudaGraph_t* pGraph) {
    CudaRtFrontend::Prepare();
    CudaRtFrontend::AddDevicePointerForArguments(stream);
...
// TODO: needs testing
extern "C" __host__ cudaError_t CUDARTAPI cudaStreamGetPriority(cudaStream_t hStream, int* priority) {
    CudaRtFrontend::Prepare();
    CudaRtFrontend::AddDevicePointerForArguments(hStream);
    CudaRtFrontend::Execute("cudaStreamGetPriority");
    if (CudaRtFrontend::Success())
        *priority = CudaRtFrontend::GetOutputVariable<int>();
    return CudaRtFrontend::GetExitCode();
}