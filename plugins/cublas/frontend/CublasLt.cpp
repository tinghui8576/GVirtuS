...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulAlgoGetHeuristic(cublasLtHandle_t lightHandle,
    ...
    if (CublasFrontend::Success()) {
        ...
        cublasLtMatmulHeuristicResult_t *temp = CublasFrontend::GetOutputHostPointer<cublasLtMatmulHeuristicResult_t>(requestedAlgoCount);
        memcpy(heuristicResultsArray, temp, requestedAlgoCount * sizeof(cublasLtMatmulHeuristicResult_t));
...
// TODO
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatrixLayoutSetAttribute(cublasLtMatrixLayout_t matLayout,
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulDescSetAttribute(
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulDescCreate(cublasLtMatmulDesc_t *matmulDesc,
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulPreferenceSetAttribute(cublasLtMatmulPreference_t pref,
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulPreferenceCreate(cublasLtMatmulPreference_t *preference) {
    CublasFrontend::Prepare();
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmulPreferenceDestroy(cublasLtMatmulPreference_t pref) {
    CublasFrontend::Prepare();
    CublasFrontend::AddDevicePointerForArguments(pref);
...
extern "C" CUBLASAPI cublasStatus_t CUBLASWINAPI cublasLtMatmul(cublasLtHandle_t       lightHandle,
