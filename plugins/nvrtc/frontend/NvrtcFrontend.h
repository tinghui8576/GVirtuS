...
#ifndef NVRTCFRONTEND_H
#define NVRTCFRONTEND_H
...
class NvrtcFrontend {
   public:
    ...
    static inline nvrtcResult GetExitCode() {
        return (nvrtcResult)Frontend::GetFrontend()->GetExitCode();
    }

    static inline bool Success() { return Frontend::GetFrontend()->Success(NVRTC_SUCCESS); }
