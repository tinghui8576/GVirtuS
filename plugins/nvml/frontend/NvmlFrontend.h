...
#ifndef NVMLFRONTEND_H
#define NVMLFRONTEND_H
...
class NvmlFrontend {
   public:
    ...
    static inline nvmlReturn_t GetExitCode() {
        return (nvmlReturn_t)Frontend::GetFrontend()->GetExitCode();
    }

    static inline bool Success() { return Frontend::GetFrontend()->Success(NVML_SUCCESS); }
