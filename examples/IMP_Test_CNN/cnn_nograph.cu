...
int main()
{
	...
	std::ofstream csvFile("NoGraph.csv");
    ...
    for (int numsample : counts) {
        ...
        // printf("\n Error Rate = %f%% (%d out of %d)\n", double(error) / double(test_cnt) * 100.0, error, numsample);
        // printf("Accuracy = %.3f%% (%d out of %d)\n",
        //     100.0 - double(error) / double(test_cnt) * 100.0, test_cnt - error, numsample);
