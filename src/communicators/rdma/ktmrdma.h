 ...
 * @throws std::string If rdma_getaddrinfo encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_create_ep encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_reg_msgs encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_reg_read encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @param length The length of the local buffer.
 * @return A pointer to the memory region associated with the registered buffer.
 * @throws std::string If rdma_reg_write encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_connect encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_listen encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_get_request encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @param id A pointer to the RDMA communication identifier.
 * @param conn_param A pointer to the connection parameters.
 * @throws std::string If rdma_accept encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_post_recv encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_post_send encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @throws std::string If rdma_get_send_comp encounters an error, an exception is thrown with an
 * error message.
 */
 ...
 * @throws std::string If rdma_get_recv_comp encounters an error, an exception is thrown with an
 * error message.
 */
 ...
 * @throws std::string If rdma_post_read encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 * @param rkey The remote key associated with the remote memory region.
 * @throws std::string If rdma_post_write encounters an error, an exception is thrown with an error
 * message.
 */
 ...
 *
 * This function performs the exchange of RDMA-related information such as the remote address and
 * remote rkey between the client and the server using RDMA operations.
 *
 * @note This function must be called AFTER calling `ktm_server_exchange_rdma_info` function on the
 * server side. The two functions must always be used together to ensure a proper exchange of RDMA
 * information.
 *
 * @param id A pointer to the RDMA communication identifier.
 ...
 *
 * This function performs the exchange of RDMA-related information such as the remote address and
 * remote rkey between the server and the client using RDMA operations.
 *
 * @note This function must be called BEFORE calling `ktm_client_exchange_rdma_info` function on the
 * client side. The two functions must always be used together to ensure a proper exchange of RDMA
 * information.
 *
 * @param id A pointer to the RDMA communication identifier.
 * @param addr A pointer to the local buffer for RDMA operations.
